...
while True:
    ...
    for circuit in root.findall('ns:CircuitTable/ns:Circuit', ns):
        ...
        long = location.attrib.get('long')
        circuits.append((circuit_name,locality,country, lat, long))
...
for circuit in circuits:
    cursor.execute('INSERT INTO circuits (name, locality, country, latitude, longitude) VALUES (%s,%s,%s,%s,%s)', circuit)
