...
for race in races_data:
    ...
    t_list = [raceID,driverID,constructorID,position,points,status]
    t_tuple = tuple(t_list)
    print(t_tuple)
    cursor.execute('INSERT INTO results (race_id, driver_id, constructor_id, position, points, status) VALUES (%s,%s,%s,%s,%s,%s)', t_tuple)
